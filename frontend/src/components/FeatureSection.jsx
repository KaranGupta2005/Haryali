...
const haryaliFeatures = [
  {
    ...
    description:
      "Simple voice or app registration for farmers in regional languages.",
    color: "#10b981",
  ...
  },
  {
    ...
    description:
      "Locate farms, view ready-for-pickup listings, and track deliveries.",
    color: "#22c55e",
  ...
  },
  {
    ...
    description: "Farmers set harvest dates and mark 'Ready for Pickup' easily.",
    color: "#84cc16",
  ...
  },
  {
    ...
    description:
      "Instant UPI payouts with escrow and encrypted transactions.",
    color: "#059669",
  ...
  },
  {
    ...
    description:
      "Predict fair crop residue price per ton based on supply, distance, and moisture.",
    color: "#14b8a6",
  ...
  },
  {
    ...
    icon3D: "sphere",
    title: "Satellite Yield Estimation",
    description:
      "Use NDVI satellite data to estimate crop residue yield before listing.",
    color: "#10b981",
  ...
  },
  {
    ...
    icon3D: "box",
    title: "Gamification & Green Badges",
    description:
      "Reward farmers for sustainable practices and reduce crop burning.",
    color: "#22c55e",
  ...
  },
  {
    ...
    description:
      "Seamlessly manage crop transport and delivery tracking in one place.",
    color: "#059669",
    ...
    >
      ...
      <div className="relative h-full p-8 rounded-3xl transition-all duration-500 hover:scale-105 cursor-pointer bg-gradient-to-br from-gray-900/90 to-green-950/90 hover:from-gray-900 hover:to-green-950 backdrop-blur-xl border border-green-700/30 hover:border-green-500/50 shadow-xl hover:shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center h-full">
          ...
          <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:from-green-400 group-hover:to-emerald-400 transition-all duration-300">
            {feature.title}
          </h3>
    ...
    <section className="relative px-6 py-24 bg-gradient-to-br from-gray-900 via-green-950 to-gray-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10 text-center mb-20">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Experience crop residue management like never before — farmers, buyers,
          and logistics providers all connected in one smart platform.
        </p>
      </div>

      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {haryaliFeatures.map((feature, index) => (
