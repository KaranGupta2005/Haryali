...
const features = [
  {
    ...
    description:
      "Simple voice or app registration for farmers in regional languages with step-by-step guidance.",
  ...
  },
  {
    ...
    description:
      "Locate farms, view ready-for-pickup listings, and track deliveries in real-time on an intuitive map interface.",
  ...
  },
  {
    ...
    description:
      "Farmers set harvest dates and mark 'Ready for Pickup' with automated notifications to buyers.",
  ...
  },
  {
    ...
    description:
      "Instant UPI payouts with escrow protection and encrypted transactions for peace of mind.",
  ...
  },
  {
    ...
    description:
      "Predict fair crop residue pricing per ton based on supply, distance, moisture, and market trends.",
  ...
  },
  {
    ...
    description:
      "Use NDVI satellite data to estimate crop residue yield before listing with 95% accuracy.",
    gradient: "from-emerald-400 to-teal-500",
    benefits: [
      "Satellite Imagery",
      "NDVI Analysis",
      "Yield Prediction",
      "Pre-harvest Insights"
    ]
  },
  {
    id: 7,
    ...
    title: "Green Badges",
    description:
      "Reward farmers for sustainable practices with gamification, badges, and incentives to reduce crop burning.",
  ...
  },
  {
    ...
    description:
      "Monitor your environmental contribution through crop residue saved and emissions reduced — no counters, just impact.",
  ...
  return (
    ...
    >
      <div className="w-40 h-40 rounded-full bg-gradient-to-br from-white/80 to-white/20 shadow-xl flex items-center justify-center group-hover:shadow-2xl transition-all duration-500 border-4 border-green-100 group-hover:border-green-300">
        <div
          className={`p-4 rounded-full bg-gradient-to-r ${feature.gradient} text-white transform transition-all duration-300 group-hover:scale-110`}
        >
          {feature.icon}
        </div>
      </div>
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div
            className={`h-40 bg-gradient-to-r ${feature.gradient} relative flex items-center justify-center`}
          >
...
export default function Features() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#ABE188" }}
    >
      {/* Background soft blurs */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-green-300 rounded-full blur-3xl opacity-30 animate-pulse" />
      <div
        className="absolute bottom-20 right-10 w-96 h-96 bg-emerald-300 rounded-full blur-3xl opacity-30 animate-pulse"
      ...
      <div className="relative z-10 px-6 py-16">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-800 max-w-3xl mx-auto leading-relaxed">
            Click on any feature circle to discover how we're revolutionizing
